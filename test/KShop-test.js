...
const tokenJSON = require("../artifacts/contracts/Erc.sol/KabbaToken.json")

describe("KShop", function () {
    let owner
    let buyer
    let shop
    let erc20
    ...
    beforeEach(async function() {
      ...
      const KShop = await ethers.getContractFactory("KShop", owner)
      shop = await KShop.deploy()
      await shop.deployed() 
